      ...
      <section className="relative bg-gradient-to-br from-cs-dark via-gray-900 to-cs-dark py-20 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <Badge variant="outline" className="mb-6 bg-cs-blue/10 text-cs-blue border-cs-blue/20">
              ✨ Premium CS:GO & CS2 Marketplace
            </Badge>
            
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Trade Premium
              <span className="text-cs-blue bg-gradient-to-r from-cs-blue to-blue-400 bg-clip-text text-transparent">
                {" "}CS Skins
              </span>
            </h1>
